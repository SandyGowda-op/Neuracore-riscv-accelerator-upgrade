...
\[
512 \times \frac{2}{4} = 256\text{ MACs}
\]

Therefore:

\[
\boxed{50\% \text{ MAC reduction}}
\]

This is the most direct hardware consequence of enforcing 2:4 sparsity.
...
\[
128B_A + 256B_B + 64B_{metadata}=448B
\]

Reduction:

\[
\frac{512-448}{512}\times100
=
\boxed{12.5\%}
\]
...
\[
512_A + 512_B = 1024\text{ reads}
\]

Sparse scratchpad reads:

\[
32_A + 64_B + 16_{metadata}=112\text{ reads}
\]

Reduction:

\[
\frac{1024-112}{1024}\times100
=
\boxed{89.06\%}
\]
...
\[
\frac{43.686-22.8469}{22.8469}\times100
\approx
\boxed{91.21\%}
\]
...
\[
\boxed{4.376953\ cycles/MAC}
\]

Sparse:

\[
\boxed{2.28906\ cycles/MAC}
\]

Reduction:

\[
\frac{4.376953-2.28906}{4.376953}\times100
\approx
\boxed{47.70\%}
\]
...
\[
\boxed{4\text{ external memory requests}}
\]
...
\[
\boxed{50\%\ reduction\ in\ MAC\ work}
\]
...
\[
512B \rightarrow 448B
\]

giving:

\[
\boxed{12.5\%\ reduction}
\]
...
\[
\boxed{73.85\%\ reduction}
\]

or approximately:

\[
\boxed{3.82\times\ compute\text{-}phase\ speedup}
\]

At the same time, measured MAC utilization increases from:

\[
22.8469\% \rightarrow 43.686\%
\]

and cycles/MAC decrease from:

\[
4.376953 \rightarrow 2.28906
\]
